...
import com.rakshith.movie_ticket.repository.BookingRepository;
import com.rakshith.movie_ticket.repository.CustomerRepository;
import com.rakshith.movie_ticket.repository.SeatRepository;
...
//			model.put("qrCodeImage", qrCodeImage);
//			model.put("booking", booking);
//			session.setAttribute("success", "Booking Confirmed successfull!");
//			return "booking-details.html";
//		} else {
//			session.setAttribute("failure", "Invalid session.Please Login again");
//			return "redirect:/login";
